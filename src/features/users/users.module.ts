...
import { CleanupPendingUsersUseCase } from './application/use-cases/cleanup-pending-users.use-case';
...
import { PendingUserCleanupScheduler } from './infrastructure/schedulers/pending-user-cleanup.scheduler';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: UNSUSPEND_USER_USE_CASE,
      useExisting: UnsuspendUserUseCase
    },
