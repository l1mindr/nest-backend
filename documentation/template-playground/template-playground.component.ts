    ...
    <div class="template-playground">
      <div class="template-playground-header">
        ...
        <div class="template-playground-actions">
          ...
          <button class="btn btn-primary" (click)="resetToDefault()">
            Reset to Default
          </button>
          <button class="btn btn-success" (click)="exportZip()">
            Download Templates
          </button>
        </div>
      </div>
...
export class TemplatePlaygroundComponent implements OnInit, OnDestroy {
  ...
  private async createSession(): Promise<void> {
    const response = await this.http
      .post<Session>('/api/session/create', {})
      .toPromise();
  ...
  private async loadSessionTemplates(): Promise<void> {
    ...
    const response = await this.http
      .get<{ templates: Template[]; success: boolean }>(
        `/api/session/${this.sessionId}/templates`
      )
      .toPromise();
    if (response && response.success) {
  ...
  private async loadSessionConfig(): Promise<void> {
    ...
    const response = await this.http
      .get<{ config: CompoDocConfig; success: boolean }>(
        `/api/session/${this.sessionId}/config`
      )
      .toPromise();
    if (response && response.success) {
  ...
  async selectFile(template: Template) {
    ...
    try {
      const response = await this.http
        .get<{ content: string; success: boolean }>(
